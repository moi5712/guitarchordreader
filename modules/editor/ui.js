...
import { closeModal, openModal, showAlert, showConfirm, initCustomSelect } from '../utils/ui-utils.js';
...
export function initEditor() {
    ...
    const editorHelpBtn = document.getElementById("editorHelpBtn");
    const editorHelpModal = document.getElementById("editorHelpModal");
    const editorHelpClose = document.getElementById("editorHelpClose");

    if (editorHelpBtn && editorHelpModal) {
        editorHelpBtn.addEventListener("click", () => openModal(editorHelpModal));
        editorHelpClose?.addEventListener("click", () => closeModal(editorHelpModal));
        editorHelpModal.addEventListener("click", (e) => {
            if (e.target === editorHelpModal) closeModal(editorHelpModal);
        });
    }
    ...
    if (modalUgConvertBtn) {
        modalUgConvertBtn.addEventListener("click", () => {
            closeModal(editorMobileSettingsModal);
            runUGConvert();
        });
    }
